...
//	    }
	...
	public String bookMovie(Session session) {
		...
		System.out.println("Enter the movie id of the movie you want to watch.");
		 for (Movie movie : movies) {
			System.out.print(movie.getId()+" " +movie.getName()+ " "+movie.getRating()+" "+movie.getLanguage()+" "+movie.getReleaseDate());
		}
	    ...
	    for(CinemaHall cinemaHalls:cinemaHall) {
	    	...
	    	System.out.print(cinemaHalls.getId()+" "+cinemaHalls.getLocation() +" "+cinemaHalls.getRating()+" "+cinemaHalls.getMoviesAndTimings());
	    }
	    ...
	    public void bookingDetails(Session session, int ticketNumber ) {
    ...
    public static void main( String[] args )
    {
        ...
        case 1:app.bookMovie(session); break;
